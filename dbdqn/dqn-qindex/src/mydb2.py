...
class Mydb:
    ...
    def __init__(self, mydb_dump_number):
        ...
        if mydb_dump_number is None:
            ...
            with shelve.open('../data/mydb2_dump/mydb2_dump_in_episode' + str(mydb_dump_number)) as f:
    ...
    def save_mydb2(self, episode):
        ...
        with shelve.open('../data/mydb2_dump/mydb2_dump_in_episode_test' + str(episode)) as fw:
    ...
    def load_workload(self):
        ...
        :return:
        """
        with shelve.open("../data/preprocess/priority.dat") as f1:
            for key in f1.keys():
                self.workload.append(key)
                self.all_sql_pri_results[key] = f1[key]

        with shelve.open("../data/preprocess/workload_stats") as f2:
            self.ps_in_workload = f2['p_conditions_set']

        with shelve.open("../data/preprocess/attribute_map.dat") as f3:
            for key in f3.keys():
    ...
    def merge(self, tnum1, tnum2, choice):
        ...
        tchar_maps_for_merge_fetch = self.__init_tchar_maps_for_merge_fetch()
    ...
    def get_total_time(self):
        ...
        for sql in self.workload:  # 遍历工作负载中的每一条sql语句
            ...
            #     if tnum_match:
            #         used_tnum.add(tnum_match.group(1))
            # self.dqn_logger.write(list(used_tnum))
    ...
    def plain_search(self):
        ...
        for sql in self.workload:
            ...
            time_end = time.time()
            total_time += time_end - time_start
            self.LOGGING.write('plain_search time, sql: ' + str(time_end - time_start) + ', ' + sql, True)
        return total_time
    ...
    def __init_tchar_maps_for_merge_fetch(self):
        maps = {}
...
class MydbLogger:
    ...
    def __init__(self, path='../data/mydb-log.txt'):
        self.f = open(path, 'w')
...
if __name__ == '__main__':
    mydb = Mydb(None)
    #mydb.init_t0("../data/University1_2.nt")
