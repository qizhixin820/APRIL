...
public class IndexController {
	...
	public Result<String> start(HttpServletRequest request) throws Exception {
		...
		if (choose[0].equals("0")) {
			String[] args = new String[] { "D:\\MyEnv\\Anaconda\\envs\\ml\\python",
					"D:\\Download\\dbdqn\\dqn-qindex\\src\\tes_dqn.py" };
	...
	public Result<String> startUserSpecific(HttpServletRequest request) throws Exception {
		...
		File argsFile = new File("D:\\DriveY\\Spring\\AprilBackend\\src\\main\\resources\\file\\index_contrast_args.txt");
		...
		fileWriter.close();
		String[] args = new String[] { "D:\\MyEnv\\Anaconda\\envs\\ml\\python",
				"D:\\Download\\dbdqn\\dqn-qindex\\src\\start_user_specific.py",
				"D:\\DriveY\\Spring\\AprilBackend\\src\\main\\resources\\file\\index_contrast_args.txt" };
		for (String string : args) {
			System.out.print(string + " ");
		}
		System.out.println();
		...
		int ret = process.waitFor();
		System.out.println("return value:" + ret);
		File file = new File("D:/Download/dbdqn/dqn-qindex/data/log/lubm_contrast.txt");
		FileReader fileReader = new FileReader(file);
		BufferedReader bufferedReader = new BufferedReader(fileReader);
		String line = bufferedReader.readLine();
		if (line != null) {
